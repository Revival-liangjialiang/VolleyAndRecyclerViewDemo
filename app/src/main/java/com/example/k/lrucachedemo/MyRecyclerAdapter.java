...
public class MyRecyclerAdapter extends RecyclerView.Adapter<MyRecyclerAdapter.MyViewHolder> {
    ...
    public MyRecyclerAdapter(Context context, int itemCount, RequestQueue requestQueue, int spanWidth) {
        super();
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        MyViewHolder waterFallVH=new MyViewHolder(view);
        return waterFallVH;
    }
    ...
    private void sendVolleyRequest(final MyViewHolder holder, final int position) {
